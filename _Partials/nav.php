...
<head>
    ...
    <link href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet"
         ...
         <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
          ...
          <link rel="stylesheet" href="a.css?v=3">
  ...
  <div class="container">
    ...
    <div class="container">
      <ul class="nav navbar-nav d-inline-block text-uppercase">
        ...
        <li class="d-inline-block mx-2"><a href="allpost.php?category_id=<?php echo $row['id'];?>"><?php echo $row['CategoryName'];?></a></li>
          <?php }?>
      </ul>
    </div>
  </div>
          ...
          <!-- latest news------------------------------------------------------------ -->
            ...
            if($latest_n){
              ...
              while( $rows = mysqli_fetch_assoc($latest_n) ){
                ...
                ?>
               <li><a href='detail.php?id=<?php echo $id; ?>'><img   src="./admin/postimages/<?php echo $img; ?>"> <?php echo $heading ?> </a></li>
                <?php
                if( $i > 4 ){
                  break;
                }
