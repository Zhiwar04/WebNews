...
<body>
  <header>
    <h2 style=" position:relative;  background: #fff;box-shadow: 0 0 40px #00000021; padding:.8rem;">بەخێربێیتەوە <span style="color:#011a89e0;">
        <?php
  ...
  <main>
    <div class="menu-container">
      ...
      <ul class="vertical-nav">
        ...
        <li class="log-out">
          <a title="Sign out" href="logout.php" class="img"><img src="../assets/image/user/logout.png" alt=""></a>
        </li>
      </ul>
